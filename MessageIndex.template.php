		...
		foreach ($context['boards'] as $board)
		{
			echo '
				<tr id="board_', $board['id'], '" class="windowbg2">
					<td class="icon windowbg"', !empty($board['children']) ? ' rowspan="2"' : '', ' style="border-left: 1px solid #e3e3e3; border-right: 1px solid #e3e3e3; border-bottom: 1px solid #e3e3e3;">
			...
			echo '
					...
					<td class="info" style="border-right: 1px solid #e3e3e3; border-bottom: 1px solid #e3e3e3;">
			...
			echo '
					...
					<td class="stats windowbg" style="border-right: 1px solid #e3e3e3; border-bottom: 1px solid #e3e3e3;">
						<p>', comma_format($board['posts']), ' ', $board['is_redirect'] ? $txt['redirects'] : $txt['posts'], ' <br />
						', $board['is_redirect'] ? '' : comma_format($board['topics']) . ' ' . $txt['board_topics'], '
						</p>
					</td>
					<td class="lastpost" style="border-right: 1px solid #e3e3e3; border-bottom: 1px solid #e3e3e3;">';
			...
			if (!empty($board['children']))
			{
				...
				echo '
				<tr id="board_', $board['id'], '_children"><td colspan="3" class="children windowbg" style="border-right: 1px solid #e3e3e3; border-bottom: 1px solid #e3e3e3;"><strong>', $txt['parent_boards'], '</strong>: ', implode(', ', $children), '</td></tr>';
			}
		}
		echo '
				</tbody>
